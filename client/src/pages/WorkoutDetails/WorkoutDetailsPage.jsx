...
//   const [isSaving, setIsSaving] = useState(false); // New state to handle saving process
...
//         // Post the updated initial exercise again
//         const createdExercises = await Promise.all(
//           updatedExercises.map(async (exercise) => {
//             if (
//               exercise.workout_id === createdWorkout.workout_id &&
//               exercise.exercise_id == null
//             ) {
//               return await postExercise(exercise);
//             } else {
//               return exercise;
//             }
//           })
