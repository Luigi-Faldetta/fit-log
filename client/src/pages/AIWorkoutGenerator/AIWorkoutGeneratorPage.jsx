...
const AIWorkoutGenerator = () => {
  ...
  const generateWorkout = async () => {
    try {
      ...
      // CRITICAL: Sanitize AI response before parsing to prevent XSS
      const sanitizedWorkout = sanitizeAIResponse(generatedWorkout);

      setWorkout({
        name: 'AI-Generated Workout',
        description: 'Workout generated by AI',
        exercises: parseWorkoutText(sanitizedWorkout),
      });
